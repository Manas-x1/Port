    ...
    return (
        <div className="w-full text-on-surface">
                ...
                <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-element-lg items-start reveal">
                    ...
                    <div className="pt-8 md:pt-16">
                        <p className="font-body-lg text-body-lg text-ink leading-relaxed mb-8">
                            SPECTRAL CUT details grading pipelines, custom LUT development, and chromatic depth mapping.
                        </p>
                        <p className="font-body-md text-body-md text-graphite leading-relaxed">
                            Through precise control of log ranges, black levels, and specular highlights, we map out atmospheric color tones. The grade mimics high-end cinema stocks while keeping the strict contrast discipline of our design system.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="w-full bg-surface-container-lowest">
                <div className="relative w-full aspect-video md:h-[90vh] overflow-hidden reveal">
                    <img 
                        ...
                        alt="Spectral Cut Detail View 01"
                        src="https://images.unsplash.com/photo-1550684848-fac1c5b4e853?q=80&w=1200&auto=format&fit=crop"
                    />
            ...
            <section className="relative w-full h-[70vh] group cursor-pointer overflow-hidden bg-surface-container-lowest">
                <Link to="/neo-noir" className="absolute inset-0 block">
                    ...
                    <div className="relative h-full flex flex-col items-center justify-center text-center">
                        ...
                        <h3 className="font-display text-display uppercase tracking-tighter mb-8 text-[#ffffff]">Neo-Noir</h3>
